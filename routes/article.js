...
import {createArticle, articleById, readArticle, deleteArticle, updateArticle, allArticles, relatedArticles, allArticlesProjects, articleSearch, articleImages} from "../controllers/article.js";
...
router.get("/article/photo/:articleId", articleImages);
